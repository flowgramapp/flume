...
export const createSVG = ({from, to, stage, id, outputNodeId, outputPortName, inputNodeId, inputPortName, stroke}) => {
...
export const getStageRef = editorId => document.getElementById(`${CONNECTIONS_ID}${editorId}`);
